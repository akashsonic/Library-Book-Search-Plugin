...
1. Upload the plugin files to the `/wp-content/plugins/Library-Book-Search-Plugin` directory, or install the plugin through the WordPress plugins screen directly.
